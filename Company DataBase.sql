...
-- Find all Clients
Select * From CLIENT
-- Find all employeed ordered by salary
...
-- Find the forenames and surnames of employees
Select first_name AS forename, last_name AS surname From employee;
-- Find out all the different genders
SELECT Distinct sex from employee;
-- Find all the Brnach IDs
...
-- Find how much the compnay is paying in the payrolls
Select SUM(salary) from employee;
-- Find how many males and females are in our data
...
from Works_With 
GROUP BY emp_id;
-- Find employees who are an LLC
Select * From Client
Where client_name LIKE '%LLC%';
-- Find any branch suppliers who is in the Label Business
...
-- Michael Scott Manages (Assuming you know his ID)
Select client_name 
From Client 
Where branch_id IN (
	Select branch_id 
